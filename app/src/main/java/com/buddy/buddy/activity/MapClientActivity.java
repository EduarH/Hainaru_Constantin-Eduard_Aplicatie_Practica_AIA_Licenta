...
public class MapClientActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private void selectDestination() {
        ...
        if (!stateButtonDestination){
            ...
            editTextDestination.setHint("Select your destination");
        }
    }
    ...
    private void getActiveDrivers() {
        geofireController.getActiveDrivers(mlatLng, 10).addGeoQueryEventListener(new GeoQueryEventListener() {
            ...
            public void onKeyEntered(String key, GeoLocation location) {
                ...
                Marker marker = map.addMarker(new MarkerOptions().position(driverLatLng).title("Buddy available").icon(BitmapDescriptorFactory.fromResource(R.drawable.icon_map_car)));
                marker.setTag(key);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.itemPayment:
                Toast.makeText(getApplicationContext(), "This feature is on development", Toast.LENGTH_SHORT).show();
                break;
            default:
    ...
    private void getRoute() {
        if (originLatLng != null && destinationLatLng != null){
            ...
            Toast.makeText(this, "Select the place of departure and the destination to continue.", Toast.LENGTH_LONG).show();
        }
    }
