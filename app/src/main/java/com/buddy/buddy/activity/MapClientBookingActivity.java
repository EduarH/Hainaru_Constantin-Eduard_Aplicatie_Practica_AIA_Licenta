            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    if (status.equals("accept")){
                        textViewState.setText("Status: accepted");
                    }else if (status.equals("start")){
                        textViewState.setText("Status: started");
                        startBooking();
                    }else if (status.equals("finish")){
                        textViewState.setText("Status: Completed");
                        finishBooking();
                    }
                }
            }
        ...
        clientBookingController.getClientBooking(userController.getUidCurrentUser()).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    //map.addMarker(new MarkerOptions().position(originLatLng).title("Pick up").icon(BitmapDescriptorFactory.fromResource(R.drawable.icon_person_location)));
                    getDriver(idDriver);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    if (firstTime){
                        ...
                        map.addMarker(new MarkerOptions().position(latLngOr).title("Pick up here").icon(BitmapDescriptorFactory.fromResource(R.drawable.icon_person_location)));
                        firstTime = false;
