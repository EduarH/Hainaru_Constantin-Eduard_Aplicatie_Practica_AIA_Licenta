    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("CUSTOMER_SELECTED_CATEGORY_NAME", driverCategory.getName());
...
//                    polylineOptions.color(Color.rgb(65,205,125));
    ...
    public void onMapReady(@NonNull GoogleMap googleMap) {
        ...
        map.addMarker(new MarkerOptions().position(originLatLng).title("Origin").icon(BitmapDescriptorFactory.fromResource(R.drawable.icon_person_location)));
